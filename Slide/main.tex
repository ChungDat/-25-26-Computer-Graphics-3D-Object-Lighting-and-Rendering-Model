...
\begin{frame}{Nguồn sáng hình học}
	...
	\begin{center}
		\begin{math}
			...
			f_{att}(r) = \frac{1}{k_c + k_l * r + k_q * r^2}\\
			l = \frac{(p_i - x)}{||p_i - x||}
...
\begin{frame}{Cài đặt}
	\begin{columns}[T]
		...
		\begin{column}{0.5\textwidth}
			...
			% TOP-LEFT CELL
			\begin{center}
				\includegraphics[width=0.4\linewidth]{imagens/vertex_processing.png}
			\end{center}
		...
		\begin{column}{0.5\textwidth}
			...
			% TOP-RIGHT CELL
			\begin{center}
				\includegraphics[height=0.4\textheight]{imagens/coordinate_systems.png}
			\end{center}
