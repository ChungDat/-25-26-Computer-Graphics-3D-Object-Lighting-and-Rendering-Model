...
void Shader::setVec3f(const std::string& name, float valueX, float valueY, float valueZ) const {
	setVec3fv(name, glm::vec3(valueX, valueY, valueZ));
}
...
void Shader::setVec4fv(const std::string& name, glm::vec4 value) const {
